export const en = {
  ...
  form: {
    title: 'Form lab',
    description:
      'Portal stress test: Select, Popover, Calendar, Combobox, Dialog, Sheet, Tooltip, DropdownMenu, and Sonner toasts. Overlays portal to document.body — verify they stack above shell chrome when embedded.',
    fieldTitle: 'Title',
    fieldTitlePlaceholder: 'Ship portal smoke test',
    fieldTitleHint: 'At least 3 characters.',
    fieldDescription: 'Notes',
    fieldDescriptionPlaceholder: 'What should reviewers check in the shell?',
    fieldTeam: 'Team',
    ...
    fieldNotifyHint: 'Switch still lives in the form tree; overlays do not.',
    ...
    validationDescription: 'Notes must be at least 8 characters.',
    validationTeam: 'Choose a team.',
    validationPriority: 'Choose a priority.',
    ...
    toastSubmitReadyDesc: 'Confirm in the dialog (portal).',
    ...
    dialogDescription: 'Dialog content is portaled to document.body.',
    dialogCancel: 'Cancel',
    dialogConfirm: 'Confirm submit',
    sheetTitle: 'Live preview',
    sheetDescription: 'Sheet content is portaled to document.body.',
    yes: 'Yes',
    no: 'No',
  },
  crash: {
