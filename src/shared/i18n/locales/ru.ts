export const ru = {
  ...
  form: {
    title: 'Лаборатория форм',
    description:
      'Стресс-тест порталов: Select, Popover, Calendar, Combobox, Dialog, Sheet, Tooltip, DropdownMenu и Sonner. Оверлеи уходят в document.body — проверьте поверх chrome shell во встроенном режиме.',
    fieldTitle: 'Заголовок',
    fieldTitlePlaceholder: 'Проверка порталов',
    fieldTitleHint: 'Минимум 3 символа.',
    fieldDescription: 'Заметки',
    fieldDescriptionPlaceholder: 'Что проверить в shell?',
    fieldTeam: 'Команда',
    ...
    fieldNotifyHint: 'Switch остаётся в дереве формы; оверлеи — нет.',
    ...
    validationDescription: 'Заметки — минимум 8 символов.',
    validationTeam: 'Выберите команду.',
    validationPriority: 'Выберите приоритет.',
    ...
    toastSubmitReadyDesc: 'Подтвердите в dialog (портал).',
    ...
    dialogDescription: 'Содержимое Dialog портируется в document.body.',
    dialogCancel: 'Отмена',
    dialogConfirm: 'Подтвердить',
    sheetTitle: 'Живое превью',
    sheetDescription: 'Содержимое Sheet портируется в document.body.',
    yes: 'Да',
    no: 'Нет',
  },
  crash: {
